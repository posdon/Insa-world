...
namespace POO_Rachid_Gimenez
{
     ...
     * ReadMe check !
     */
    public class GameBuilderReplay : GameBuilder
    {       
        public Game Game
        {
            get;
        ...
        public GameBuilderReplay(){
            Game = new GameReplay();
        }

        public GameBuilderReplay(String s){
            Game = new GameReplay();
            Load(s);
        }
        ...
        public void Load(String s)
        {
            ...
            using (StreamReader sr = new StreamReader(s))
            {
                ...
                {
                    if (line.Equals("GAME_STATE='RUNNING'\n"))
                    {
                    ...
                    if (line.Equals("<PLAYER>"))
                    {
                        ...
                        while (!line.Equals("</PLAYER>"))
                        {
                            ...
                            if (m.Success)
                            {
                                ...
                                e.LifePoint = (new RaceFactory()).GetRace(p.RaceString).LifePoint;
                                e.MovePoint = (new RaceFactory()).GetRace(p.RaceString).MovePoint;
                                e.Pos = Game.Map.SpawnList[playerCount];
                                p.AddEntity(e);
                                allEntity.Add(e);
                    ...
                    if (line.Equals("<FIGHT_ACTION>"))
                    {
                        ...
                        if (m.Success)
                        {
                            ...
                            foreach (Entity e in allEntity)
                            {
                                ...
                                {
                                    atk = e;
                                    Console.WriteLine(atk.Race.GetAtkPoint());
                                }
                                if (e.Id == Int32.Parse(m.Groups[2].Value))
                                {
                                    def = e;
                                    Console.WriteLine(def.Race.GetDefPoint());
                                }
